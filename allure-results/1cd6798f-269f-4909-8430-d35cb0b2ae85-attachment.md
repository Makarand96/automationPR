...
> 24 |         await newPage.waitForTimeout(1000);
  ...
  46 |     await years.nth(index).click();
  47 |      await newPage.waitForTimeout(1000);
  48 | 
  49 |     await years.nth(dateNum).click();
  50 |      await newPage.waitForTimeout(1000);
  51 | 
  52 |     const dateValue =await newPage.locator(".react-date-picker__inputGroup").locator('input').nth(1).getAttribute('value');
  53 | 
